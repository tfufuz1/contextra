...
> ⚠️ **WARNUNG**: Das "Layer"-Feld dieser Datei ist ein rein build-graph-abgeleitetes Sortierkriterium und darf NICHT mit dem in `capabilities.toml`/`AGENTS.md` definierten Ring-Modell verwechselt werden, da die Zuordnungen nachweislich divergieren (Beispiel: `contextra-privacy` ist Ring 3, nicht "Layer 0").
