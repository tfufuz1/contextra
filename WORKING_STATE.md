...
- Letzter Commit: d66fc9f test(memfuse-kvcache): add golden greedy decode, tenant isolation, and cancellation tests (#3458)
- Letzter Merge: keine
...
| :--- | :---: | :---: | :--- | :--- |
| `memfuse-adapt` | 0 | 2889 | 🟢 Clean | Adaptive controllers, bandits, and PID regulators for MemFuse |
| `memfuse-sys` | 0 | 526 | 🟢 Clean | Low-level unsafe system abstractions and FFI island for MemFuse (Ring 0) |
| `memfuse-types` | 0 | 5961 | 🟢 Clean | Canonical domain types, IDs, budgets, filters, and error types for MemFuse |
| `memfuse-wire` | 0 | 2020 | 🟢 Clean | Ring 0 Unsafe Island: Auto-generated FlatBuffers IPC code and zero-copy adapters for MemFuse |
| `memfuse-mvcc` | 1 | 1955 | 🟢 Clean | Multi-Version Concurrency Control (MVCC), sequence log, and transaction buffer for MemFuse |
