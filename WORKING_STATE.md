...
- Letzter Commit: 0f300e7 feat(rank): create memfuse-rank Ring 0 crate (#3344)
- Letzter Merge: keine
...
| `memfuse-text` | 3 | 8233 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
...
| `memfuse-store` | 5 | 27253 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-vector` | 5 | 17305 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
...
| `memfuse-db` | 8 | 12808 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
