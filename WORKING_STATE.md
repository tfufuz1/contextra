...
- Letzter Commit: ceee3f4 Shell-Commit
- Letzter Merge: keine
...
|---|---|---|---|---|---|---|
| `crates/memfuse-graph/src/csr.rs` | 1620 | `-` | `TODO` | `IP-08-BUDGET-COUPLING` | `2026-09-18T12:00:00Z` | // AI-TAG[TODO][IP-08-BUDGET-COUPLING](TS:2026-09-18T12:00:00Z)(SESSION:e095d708): Connect to global ResourceTracker when cross-crate tracker handle is integrated. |
...
**Aktiver Workspace-Build**: 19 Workspace Crates (18 Kern-Crates + 1 optionales Crate `memfuse-embed`).
