...
*   **Air-Gapped & Local-First**: Keine Daten verlassen das lokale Gerät. Die Kommunikation mit Ollama (`contextra-infer-ollama`) erfolgt ausschließlich über das lokale Loopback-Netzwerk (`http://127.0.0.1:11434`).
