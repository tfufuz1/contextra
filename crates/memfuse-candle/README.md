...
`memfuse-candle` stellt die native GGUF-Inferenz und In-Memory-Inferenzunterstützung via Candle bereit (Ring 2).
...
- **Status:** 🟡 In Migration (Zielzustand: `memfuse-infer-candle`)
...
Details zum schrittweisen Umbau in `memfuse-infer-candle` gemäß §20 finden sich in [`ARCHITECTURE.md`](../../ARCHITECTURE.md) (folgt in Kürze) und `README.md` §9.
