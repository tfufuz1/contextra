...
///    `contextra-db/src/collection.rs`, der kollisionsfrei aufsteigend inkrementiert
...
///    System-Transaktionen (Muster: `contextra-checkpoint/src/lib.rs:76-79`).
///
/// **Verbotene Quellen:**
...
mod tests {
    ...
    async fn test_graph_index_defaults() {
        ...
        let res_time = index
            ...
            .await;
        match res_time {
            Err(crate::error::ContextraError::CapabilityUnsupported { capability, .. }) => {
