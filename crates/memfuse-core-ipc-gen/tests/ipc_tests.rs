// FILE-CONTEXT
// STAND: 2026-09-13T01:35:00Z (SESSION: 6381efe1)
// ZWECK: Integrationstests, Fault-Injection und Nebenläufigkeitstests für FlatBuffers IPC (memfuse-core-ipc-gen)
// INVARIANTEN: Keine Panics bei beschädigten oder abgeschnittenen IPC-Puffern; thread-sicheres Deserialisieren.
// SIEHE AUCH: docs/audits/AUDIT_memfuse-core-ipc-gen_2026-09-13.md, schemas/memfuse.fbs

use flatbuffers::FlatBufferBuilder;
use memfuse_core_ipc_gen::{
