...
fn read_search_rs() -> String {
    ...
    let paths = [
        ...
        Path::new(&manifest_dir).join("../../crates/contextra-engine/src/collection/search.rs"),
        Path::new("crates/contextra-engine/src/collection/search.rs").to_path_buf(),
        Path::new("crates/contextra-db/src/collection/search.rs").to_path_buf(),
    ];
