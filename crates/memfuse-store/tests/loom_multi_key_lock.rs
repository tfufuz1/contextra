//! Loom-basierter Nebenläufigkeitsbeweis für multi-key locking in `memfuse-store`.
//! Ausführung: RUSTFLAGS="--cfg loom" cargo test -p memfuse-store --test loom_multi_key_lock --release
//!
