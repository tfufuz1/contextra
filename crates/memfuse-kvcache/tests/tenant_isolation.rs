...
use memfuse_kvcache::{emergency_wipe, KvReusePolicy, KvSegment, TenantIsolatedKvStore};

#[test]
fn test_tenant_isolation_direct_lookup_and_segments() -> Result<(), MemFuseError> {
...
#[test]
fn test_tenant_isolation_prefix_radix_tree() -> Result<(), MemFuseError> {
    let store = TenantIsolatedKvStore::new();
...
#[test]
fn test_tenant_isolation_eviction_and_fair_recycling() -> Result<(), MemFuseError> {
    let store = TenantIsolatedKvStore::new();
...
#[test]
fn test_tenant_isolation_rollback_no_cross_tenant_impact() -> Result<(), MemFuseError> {
    let store = TenantIsolatedKvStore::new();
...
#[test]
fn test_tenant_isolation_emergency_wipe() -> Result<(), MemFuseError> {
    let store = TenantIsolatedKvStore::new();
