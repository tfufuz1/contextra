...
use memfuse_kvcache::{KvReusePolicy, KvSegment, TenantIsolatedKvStore};
...
fn simulate_greedy_decode(
    ...
    block_id: u64,
) -> Result<(Vec<u32>, usize), MemFuseError> {
...
#[test]
fn test_golden_greedy_decode_single_prompt_bit_identity() -> Result<(), MemFuseError> {
...
#[test]
fn test_golden_greedy_decode_multi_prompt_suite() -> Result<(), MemFuseError> {
...
#[test]
fn test_golden_greedy_decode_guard_refcount_during_reuse() -> Result<(), MemFuseError> {
