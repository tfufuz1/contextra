# AGENTS.md — `memfuse-privacy`

## Modulübersicht
`memfuse-privacy` ist ein Ring 3 Crate für Cloud-Egress-Sicherheit, Data Loss Prevention (DLP), Anonymisierung/Surrogate-Vaulting und Bulk-Exfiltrations-Schutz.
