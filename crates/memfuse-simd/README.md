...
`memfuse-simd` ist eine Unsafe-Insel für SIMD-Distanzkernel und Laufzeit-Hardware-Dispatch (Ring 0).
...
- **Status:** 🟢 Fertig
- **Sicherheits-Invariante:** `#![allow(unsafe_code)]` — Isoliert in `memfuse-simd`, Safe Public API Boundary.
