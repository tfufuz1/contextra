...
mod tests {
    ...
    use memfuse_infer_candle::inference::CandleModelInner;
    use memfuse_infer_candle::kv_bridge::KvCacheKey;
    use memfuse_infer_candle::{CandleLlmClient, GaspValidator, KvBridgeAdapter};
    use std::sync::Arc;
