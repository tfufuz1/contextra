...
use memfuse_infer_candle::embedding::CandleEmbedInner;
use memfuse_infer_candle::gguf_loader::parse_gguf_metadata;
use memfuse_infer_candle::inference::{CandleLlmClient, CandleModelInner, QuantizedLlamaModel};
use memfuse_infer_candle::model_registry::ModelFingerprint;
use memfuse_infer_candle::{CandleEmbedClient, MAX_CANDLE_EMBED_BATCH_SIZE};
use std::io::Write;
use std::sync::Arc;
