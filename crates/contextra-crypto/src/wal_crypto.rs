...
///
/// # Invariants
/// - Initialized with `b"contextra-wal-v1"` domain separation string as the first updated block,
...
mod tests {
    ...
    fn test_wal_hmac_anti_mirroring_reference_check() {
        ...
        ref_hmac.update(b"contextra-wal-v1"); // Domain separation string
