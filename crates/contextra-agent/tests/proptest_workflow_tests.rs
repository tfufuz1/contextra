...
// ZWECK: Property-based testing for contextra-agent structural invariants (StateGraph, AgentContext, BackgroundEvent).
...
use contextra_agent::{BackgroundEvent, NodeType, StateGraph};
