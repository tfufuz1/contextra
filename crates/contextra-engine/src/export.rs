...
mod tests {
    ...
    async fn test_export_import_roundtrip() {
        ...
        let db1 = Contextra::open_with_config(tmp1.path(), config.clone())
            .await
            .unwrap();
        ...
        let db2 = Contextra::open_with_config(tmp2.path(), config)
            .await
            .unwrap();
...
impl Contextra {
    /// Exportiert alle Collections der Contextra-Datenbank in das ExportDocumentV1 Schema.
