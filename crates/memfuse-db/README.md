...
`memfuse-db` stellt die zentrale Orchestruierungs- und Collection-API für MemFuse bereit (Ring 3).
...
- **Hauptinstanz & Collections:** `MemFuse`, `Collection`
...
Details zum Zerlegungsplan von `memfuse-db` gemäß Strangler-Muster finden sich in [`ARCHITECTURE.md`](../../ARCHITECTURE.md) (folgt in Kürze) und `README.md` §20 (Phase 3b).
