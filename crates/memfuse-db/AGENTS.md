...
2. **`kv_locks` (KvKeyLocks)**: Pro Collection feingranulares Key-Locking, schützt Mutationen.
...
dauern Sekunden! Sie DÜRFEN NIEMALS unter einem aktiven `kv_locks` Guard oder `RwLockReadGuard`
