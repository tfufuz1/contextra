//! Trait and reference implementation for tombstone semantics checking in Contextra sequence logs and indexes.
...
/// By convention in Contextra, sequence numbers (`u64`) reserve the most significant bit (bit 63)
