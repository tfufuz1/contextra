//! Deprecated: temporary local port traits have moved to `contextra-ports`.

#[deprecated(
    since = "0.1.0",
    note = "Moved to contextra_ports as part of Ring-Modell Welle 2 (siehe docs/refactor/router-db-edge-audit.md)"
)]
