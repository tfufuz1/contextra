...
`memfuse-wire` ist eine Unsafe-Insel für FlatBuffers IPC-Generat und Zero-Copy-Adapter (Ring 0).
...
- **Status:** 🟢 Fertig
- **Sicherheits-Invariante:** `#![allow(unsafe_code)]` — Isoliert in `memfuse-wire` für auto-generierten IPC-Code.

## Öffentliche API-Übersicht

- **Generated IPC:** `memfuse_generated::mem_fuse::ipc::*`
- **Adapter:** `adapter`
