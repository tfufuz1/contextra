...
pub(crate) struct GraphInner {
    ...
    /// Hyperedges stored by HyperEdgeId.
    pub(crate) hyperedges: ahash::AHashMap<hyperedge::HyperEdgeId, hyperedge::HyperEdge>,
    /// Secondary index mapping EntityId to list of HyperEdgeIds.
    pub(crate) hyperedge_index: ahash::AHashMap<EntityId, Vec<hyperedge::HyperEdgeId>>,
}
...
impl GraphInner {
    fn new() -> Self {
        Self {
            ...
            hyperedges: ahash::AHashMap::default(),
            hyperedge_index: ahash::AHashMap::default(),
        }
    }
