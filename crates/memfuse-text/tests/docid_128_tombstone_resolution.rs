...
impl StorageEngine for MockStorage {
    ...
    fn commit<'a>(&'a self, tx_id: TxId) -> memfuse_core::BoxFuture<'a, memfuse_core::Result<()>> {
        Box::pin(async move {
    ...
    fn last_tx_id<'a>(&'a self) -> memfuse_core::BoxFuture<'a, memfuse_core::Result<TxId>> {
...
#[tokio::test]
async fn test_docid_128_tombstone_resolution_exceeding_u64_max() -> memfuse_core::Result<()> {
