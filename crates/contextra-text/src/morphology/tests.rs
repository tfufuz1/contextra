use super::compound_splitter::{GermanCompoundSplitter, MorphologicalTokenizer};
use super::metrics::TokenReductionMetrics;
use super::passthrough::PassthroughTokenizer;
use super::stopwords::{is_german_stopword, normalize_umlauts};
use super::trie::Trie;
...
fn test_german_stopwords_extension_bug_txt_004() {
    let required_stopwords = [
        "nicht", "auch", "noch", "sehr", "mehr", "dann", "beim", "nach", "wenn", "aber", "durch",
        "für", "mit", "von", "zum", "zur", "ist", "sind", "war", "waren", "wird", "werden", "kann",
        "können", "soll", "sollen", "muss", "müssen", "hat", "haben", "ein", "eine", "einen",
        "einem", "einer", "des", "dem", "den",
    ];
...
// PRÜFER-KONTEXT: FRESH
// BEFUND: Re-verified test_kmu_55_compounds_suite (100% recall across 55 test cases) and entire contextra-text test suite.
// REVIEW-PASS[2/2] STATUS:PASS (ID: TEST:TXT-001) (TS: 2026-09-02T23:17:17Z) (SESSION: adced73f)
// PRÜFER-KONTEXT: FRESH
// BEFUND: Re-verified contextra-text gate-stack, zero unsafe, APM-7 slicing safety, and 77/77 tests passed.
// REVIEW-PASS[2/2] STATUS:PASS (ID: TEST:TXT-001) (TS: 2026-09-03T19:36:00Z) (SESSION: 87124619)
// PRÜFER-KONTEXT: FRESH
// BEFUND: Re-verified contextra-text gate-stack, zero unsafe, APM-7 slicing safety, Tier-2 concurrency test suite, and chaos engineering scenarios.
