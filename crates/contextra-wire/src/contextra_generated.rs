...
pub mod contextra {
    ...
    pub mod ipc {
        ...
        impl<'a> Default for RoleBindingArgs {
            #[inline]
            fn default() -> Self {
                RoleBindingArgs { role: 0, entity: 0 }
            }
        }
        ...
        impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RoleBindingBuilder<'a, 'b, A> {
            ...
            pub fn add_entity(&mut self, entity: u64) {
                self.fbb_
                    .push_slot::<u64>(RoleBinding::VT_ENTITY, entity, 0);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ...
        impl<'a> HyperEdge<'a> {
            ...
            >(
                ...
                builder.add_id(args.id);
                if let Some(x) = args.child_edge_ids {
                    builder.add_child_edge_ids(x);
                }
                builder.add_weight(args.weight);
                if let Some(x) = args.participants {
                    builder.add_participants(x);
                }
            ...
            pub fn participants(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<RoleBinding<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    ...
                    >>(HyperEdge::VT_PARTICIPANTS, None)
                }
            }
            #[inline]
        ...
        impl flatbuffers::Verifiable for HyperEdge<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    >>("participants", Self::VT_PARTICIPANTS, false)?
        ...
        impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> HyperEdgeBuilder<'a, 'b, A> {
            ...
            pub fn add_predicate(&mut self, predicate: u8) {
                self.fbb_
                    .push_slot::<u8>(HyperEdge::VT_PREDICATE, predicate, 0);
            }
            #[inline]
            pub fn add_participants(
                &mut self,
                participants: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<RoleBinding<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    HyperEdge::VT_PARTICIPANTS,
                    participants,
                );
            }
            #[inline]
            pub fn add_weight(&mut self, weight: f32) {
                self.fbb_
                    .push_slot::<f32>(HyperEdge::VT_WEIGHT, weight, 0.0);
            }
            #[inline]
            pub fn add_tx_valid_from(&mut self, tx_valid_from: u64) {
                self.fbb_
                    .push_slot::<u64>(HyperEdge::VT_TX_VALID_FROM, tx_valid_from, 0);
            }
            #[inline]
            pub fn add_tx_valid_to(&mut self, tx_valid_to: u64) {
                self.fbb_
                    .push_slot::<u64>(HyperEdge::VT_TX_VALID_TO, tx_valid_to, 0);
            }
            #[inline]
            pub fn add_business_valid_from(&mut self, business_valid_from: i64) {
                self.fbb_.push_slot::<i64>(
                    HyperEdge::VT_BUSINESS_VALID_FROM,
                    business_valid_from,
                    0,
                );
            }
            ...
            pub fn add_business_valid_to(&mut self, business_valid_to: i64) {
                self.fbb_
                    .push_slot::<i64>(HyperEdge::VT_BUSINESS_VALID_TO, business_valid_to, 0);
            }
            #[inline]
            pub fn add_source_doc_id(&mut self, source_doc_id: u64) {
                self.fbb_
                    .push_slot::<u64>(HyperEdge::VT_SOURCE_DOC_ID, source_doc_id, 0);
            }
            #[inline]
            pub fn add_child_edge_ids(
                &mut self,
                child_edge_ids: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u64>>,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    HyperEdge::VT_CHILD_EDGE_IDS,
                    child_edge_ids,
