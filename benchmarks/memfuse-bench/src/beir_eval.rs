// FILE-CONTEXT
// STAND: 2026-09-15
// ZWECK: BEIR (Benchmarking Information Retrieval) Evaluation für MemFuse BM25 + Hybrid Search.
...
/// Führt vollständige BEIR-Evaluation auf einer MemFuse-Collection durch
pub async fn run_beir_eval(
    ...
    let db = MemFuse::open_with_config(db_path, db_cfg).await?;
