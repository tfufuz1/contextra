...
impl RegressionSuite {
    ...
    pub fn baseline() -> Self {
        ...
        let scenarios = vec![
            ...
            MultiSessionScenario {
                ...
                sessions: vec![
                    Session {
                        ...
                        turns: vec![SessionTurn {
                            speaker: "User".into(),
                            text: "Alice is currently leading the Contextra database core engineering team.".into(),
                    ...
                    Session {
                        ...
                        turns: vec![SessionTurn {
                            speaker: "User".into(),
                            text: "As of Q3, Bob took over as the technical lead for the Contextra core engineering team.".into(),
                            doc_id: "doc_sup_03_new".into(),
                        }],
                    },
                ],
                query: "Who is the current team lead of Contextra core engineering?".into(),
            ...
            MultiSessionScenario {
                ...
                description: "Database engine migration (PostgreSQL -> Contextra LSM-Tree)".into(),
                question_type: LongMemEvalQuestionType::KnowledgeUpdate,
                sessions: vec![
                    Session {
                    ...
                    Session {
                        ...
                        turns: vec![SessionTurn {
                            speaker: "User".into(),
                            text: "Architectural change: We migrated storage to Contextra LSM-Tree with SSTable persistence.".into(),
                ...
                expected_keywords: vec!["Contextra".into(), "LSM-Tree".into()],
            },
            MultiSessionScenario {
    ...
    /// Evaluates the regression suite against an open Contextra `Collection`.
