...
use contextra_bench::compare::compare_metrics_files;
use std::env;
...
fn print_usage() {
    ...
    println!("  --baseline <PATH>   Path to baseline metrics JSON (default: benchmarks/contextra-bench/baseline_metrics.json)");
