...
mod tests {
    ...
    fn test_sync_docs_integration_in_temp_repo_fixture() {
        ...
        fs::write(
            ...
            r#"[workspace]
members = ["crates/memfuse-core"]
"#,
        )
        .unwrap();

        // Create crate structure
        let crate_dir = root.join("crates/memfuse-core");
...
"#,
        ...
        assert!(full_ws.contains("feat(memfuse-core): initial setup (#100)"));
