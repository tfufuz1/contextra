...
| `memfuse-text` | 2 | 6748 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
| `memfuse-candle` | 3 | 4228 | 🟢 Clean | Native Candle GGUF ML inference backend for MemFuse |
| `memfuse-index` | 3 | 18677 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-ollama` | 3 | 4573 | 🟢 Clean |  |
| `memfuse-store` | 3 | 25864 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
