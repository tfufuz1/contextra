...
| `memfuse-index` | 3 | 17470 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-ollama` | 3 | 4248 | 🟢 Clean |  |
| `memfuse-store` | 3 | 25211 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
