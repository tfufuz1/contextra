...
| `memfuse-core` | 1 | 9819 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
...
| `memfuse-agent` | 7 | 6028 | 🟢 Clean | Persistent agent workflow engine for MemFuse — checkpoint/execute/audit loop |
