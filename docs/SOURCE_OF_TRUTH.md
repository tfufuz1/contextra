...
| `memfuse-core` | 1 | 9659 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
| `memfuse-calibration` | 2 | 1789 | 🟢 Clean |  |
| `memfuse-checkpoint` | 2 | 5791 | 🟢 Clean | Backup and snapshot management for MemFuse storage |
| `memfuse-graph` | 2 | 10744 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
| `memfuse-sandbox` | 2 | 405 | 🟢 Clean | WASM Execution Boundary for MemFuse MCP CodeExecution Permission |
| `memfuse-security` | 2 | 6087 | 🟢 Clean | Encryption at Rest and KV-Cache Security utilities for MemFuse |
...
| `memfuse-index` | 3 | 16377 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-ollama` | 3 | 4248 | 🟢 Clean |  |
| `memfuse-store` | 3 | 22339 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-embed` | 4 | 2201 | 🧊 Optional |  |
| `memfuse-db` | 5 | 34828 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
| `memfuse-bench` | 6 | 4641 | 🟢 Clean | MemFuse — Reproducible Benchmark Harness for Retrieval Accuracy |
| `memfuse-router` | 6 | 6139 | 🟢 Clean |  |
| `memfuse-agent` | 7 | 6027 | 🟢 Clean | Persistent agent workflow engine for MemFuse — checkpoint/execute/audit loop |
| `memfuse-mcp` | 8 | 5570 | 🟢 Clean |  |
