...
| `memfuse-crypto` | 2 | 6608 | 🟢 Clean | Encryption at Rest and KV-Cache Security utilities for MemFuse |
...
| `memfuse-index` | 3 | 18974 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
