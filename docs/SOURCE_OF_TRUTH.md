...
| `memfuse-crypto` | 2 | 6964 | 🟢 Clean | Encryption at Rest and KV-Cache Security utilities for MemFuse |
| `memfuse-graph` | 2 | 15825 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
...
| `memfuse-store` | 3 | 26524 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
