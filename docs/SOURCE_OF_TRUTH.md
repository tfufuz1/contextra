...
| `memfuse-core` | 1 | 9861 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
...
| `memfuse-graph` | 2 | 13229 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
| `memfuse-sandbox` | 2 | 836 | 🟢 Clean | WASM Execution Boundary for MemFuse MCP CodeExecution Permission |
| `memfuse-text` | 2 | 7379 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
...
| `memfuse-db` | 5 | 36001 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
