...
| `memfuse-core` | 1 | 9826 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
...
| `memfuse-text` | 2 | 6169 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
...
| `memfuse-store` | 3 | 25523 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-embed` | 4 | 2214 | 🧊 Optional |  |
| `memfuse-db` | 5 | 35791 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
| `memfuse-bench` | 6 | 5708 | 🟢 Clean | MemFuse — Reproducible Benchmark Harness for Retrieval Accuracy |
| `memfuse-router` | 6 | 6490 | 🟢 Clean |  |
