...
| :--- | :---: | :---: | :--- | :--- |
| `memfuse-core-ipc-gen` | 0 | 1829 | 🟢 Clean | Auto-generated FlatBuffers IPC code for MemFuse Core |
| `memfuse-core` | 1 | 10585 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
| `memfuse-calibration` | 2 | 1934 | 🟢 Clean |  |
| `memfuse-checkpoint` | 2 | 6126 | 🟢 Clean | Backup and snapshot management for MemFuse storage |
| `memfuse-crypto` | 2 | 6959 | 🟢 Clean | Encryption at Rest and KV-Cache Security utilities for MemFuse |
| `memfuse-graph` | 2 | 15824 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
| `memfuse-sandbox` | 2 | 992 | 🟢 Clean | WASM Execution Boundary for MemFuse MCP CodeExecution Permission |
| `memfuse-text` | 2 | 8231 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
| `memfuse-index` | 3 | 19746 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-ollama` | 3 | 4570 | 🟢 Clean |  |
| `memfuse-store` | 3 | 26528 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-candle` | 4 | 4527 | 🟢 Clean | Native Candle GGUF ML inference backend for MemFuse |
| `memfuse-embed` | 5 | 2219 | 🧊 Optional |  |
| `memfuse-db` | 6 | 37325 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
| `memfuse-bench` | 7 | 5709 | 🟢 Clean | MemFuse — Reproducible Benchmark Harness for Retrieval Accuracy |
| `memfuse-router` | 7 | 7162 | 🟢 Clean |  |
| `memfuse-agent` | 8 | 6713 | 🟢 Clean | Persistent agent workflow engine for MemFuse — checkpoint/execute/audit loop |
| `memfuse-py` | 8 | 1877 | 🟢 Clean | Python bindings for MemFuse using PyO3 |
