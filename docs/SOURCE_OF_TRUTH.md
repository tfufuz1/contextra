...
| `memfuse-sandbox` | 2 | 311 | 🟢 Clean | WASM Execution Boundary for MemFuse MCP CodeExecution Permission |
| `memfuse-security` | 2 | 5845 | 🟢 Clean | Encryption at Rest and KV-Cache Security utilities for MemFuse |
...
| `memfuse-store` | 3 | 22050 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-embed` | 4 | 2201 | 🧊 Optional |  |
| `memfuse-db` | 5 | 34731 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
| `memfuse-bench` | 6 | 4641 | 🟢 Clean | MemFuse — Reproducible Benchmark Harness for Retrieval Accuracy |
| `memfuse-router` | 6 | 6118 | 🟢 Clean |  |
