...
| :--- | :---: | :---: | :--- | :--- |
| `memfuse-core-ipc-gen` | 0 | 1543 | 🟢 Clean | Auto-generated FlatBuffers IPC code for MemFuse Core |
...
=======
| `memfuse-graph` | 2 | 14924 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
>>>>>>> 07e10bdb (architecture-final)
...
| `memfuse-store` | 3 | 26277 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
