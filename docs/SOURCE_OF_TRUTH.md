...
| `memfuse-graph` | 2 | 16579 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
...
| `memfuse-index` | 3 | 19981 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-ollama` | 3 | 4571 | 🟢 Clean |  |
| `memfuse-store` | 3 | 26467 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
