...
| `memfuse-store` | 3 | 25289 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-embed` | 4 | 2214 | 🧊 Optional |  |
| `memfuse-db` | 5 | 35784 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
| `memfuse-bench` | 6 | 5708 | 🟢 Clean | MemFuse — Reproducible Benchmark Harness for Retrieval Accuracy |
| `memfuse-router` | 6 | 6491 | 🟢 Clean |  |
