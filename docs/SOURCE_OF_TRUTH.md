...
| :--- | :---: | :---: | :--- | :--- |
| `memfuse-core-ipc-gen` | 0 | 1828 | 🟢 Clean | Auto-generated FlatBuffers IPC code for MemFuse Core |
...
| `memfuse-graph` | 2 | 15625 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
