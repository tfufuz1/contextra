...
| `memfuse-core` | 1 | 9518 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
...
| `memfuse-security` | 2 | 5468 | 🟢 Clean | Encryption at Rest and KV-Cache Security utilities for MemFuse |
...
| `memfuse-db` | 5 | 33495 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
