...
| `memfuse-core` | 1 | 9845 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
| `memfuse-calibration` | 2 | 1789 | 🟢 Clean |  |
| `memfuse-checkpoint` | 2 | 5966 | 🟢 Clean | Backup and snapshot management for MemFuse storage |
| `memfuse-crypto` | 2 | 6414 | 🟢 Clean | Encryption at Rest and KV-Cache Security utilities for MemFuse |
| `memfuse-graph` | 2 | 11611 | 🟢 Clean | CSR-Graph for entity-relation traversal (Signal 3 in 4-Signal Fusion) |
| `memfuse-sandbox` | 2 | 459 | 🟢 Clean | WASM Execution Boundary for MemFuse MCP CodeExecution Permission |
| `memfuse-text` | 2 | 6164 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
