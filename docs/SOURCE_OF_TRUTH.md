...
| `memfuse-crypto` | 2 | 6973 | 🟢 Clean | Encryption at Rest and KV-Cache Security utilities for MemFuse |
...
| `memfuse-index` | 3 | 19749 | 🟢 Clean | HNSW vector index with SIMD distance computation for MemFuse |
| `memfuse-ollama` | 3 | 4571 | 🟢 Clean |  |
| `memfuse-store` | 3 | 26642 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-candle` | 4 | 4527 | 🟢 Clean | Native Candle GGUF ML inference backend for MemFuse |
| `memfuse-embed` | 5 | 2219 | 🧊 Optional |  |
| `memfuse-db` | 6 | 37333 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
