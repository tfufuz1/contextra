...
| `memfuse-core` | 1 | 9828 | 🟢 Clean | Core types, traits, and error handling for MemFuse |
...
| `memfuse-text` | 2 | 6182 | 🟢 Clean | MemFuse — Text processing and BM25 search for Hybrid Search |
...
| `memfuse-store` | 3 | 25627 | 🟢 Clean | LSM-Tree storage engine for MemFuse |
| `memfuse-embed` | 4 | 2214 | 🧊 Optional |  |
| `memfuse-db` | 5 | 35815 | 🟢 Clean | MemFuse — Embedded hybrid-search for AI agents |
