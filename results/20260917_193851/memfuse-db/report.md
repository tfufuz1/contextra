...
## `crates/memfuse-db/tests/docid_128_consolidation.rs`  (1 Diagnose(n))

- **ERROR [E0432]** @ `crates/memfuse-db/tests/docid_128_consolidation.rs:3:17`: unresolved import `memfuse_db::volatile_vault`
  - _Hinweis:_ found an item that was configured out
